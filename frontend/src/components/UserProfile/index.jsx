...
export default class UserProfile extends React.Component {
    ...
    handleMessageSubmit = (e) => {
        ...
        if (
            ...
            this.state.preMessage !== null &&
            this.state.preMessage !== ""
        ) {
    ...
    renderMessageInput = () => {
        if (!this.props.opponent) {
            return (
                ...
                >
                    <StyledUserProfileMessageInput
                        placeholder="Good hand?"
                        value={this.state.preMessage}
                        onChange={(e) =>
                            this.setState({ preMessage: e.target.value })
                        }
                    />
                    <StyledUserProfileMessageButton type="submit">
                        ➽
                    </StyledUserProfileMessageButton>
                </StyledUserProfileMessageForm>
            );
        ...
        return (
            <StyledUserProfile>
                <StyledUserProfileMessage
                    ...
                    hasMessage={this.state.message !== null}
                >
                    {this.state.message}
                </StyledUserProfileMessage>
                <StyledUserProfilePic
